            ...
            <table class="table table-bordered table-striped dt-responsive table-vcenter js-dataTable" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><img src="{{Session('docs')}}/img/about/{{$a->img}}" width="100px" class="img-fluid"></td>
                     
                        <td class="text-center">
                            @livewire('active', ['status' => $a->active,'modul'=> 'about','key'=> $a->id])
                            <a onClick='showM("{{url('about/'.$a->id.'/edit')}}");return false' type="button" class="btn btn-sm btn-primary" data-toggle="tooltip" title="Edit"><i class="fas fa-fw fa-pencil-alt"></i></a>
                        </td>
                    </tr> 
                    @php $x++ @endphp
                    @endforeach
