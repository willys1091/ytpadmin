                    ...
                    @foreach($postcat as $pc)
                     <tr>
                        ...
                        <td class="text-center">
                             @livewire('active', ['status' => $pc->active,'modul'=> 'postcategory','key'=> $pc->id])
                            <a onClick='showM("{{url('postcategory/'.$pc->id.'/edit')}}");return false' type="button" class="btn btn-sm btn-primary" data-toggle="tooltip" title="Edit"><i class="fas fa-fw fa-pencil-alt"></i></a>
                        </td>
                    </tr> 
                    @php $x++ @endphp
                    @endforeach
